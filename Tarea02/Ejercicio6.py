...
print(f"Cifrado (Base64): {cipher_base64}")

# Descifrado para verificar
decrypted_bytes = des_decrypt(base64.b64decode(cipher_base64), key)
print(f"Descifrado:       {decrypted_bytes.decode()}")
##Si fue mucha ayuda, grx
# =================================================================
# ATRIBUCIÓN:
# Este código implementa el estándar DES basado en las tablas de 
# permutación de la FIPS PUB 46-3.
# Las matrices y el flujo de la red de Feistel fueron tomados de la documentación inicial 
# =================================================================